...
Eigen::Matrix4d ICP(PointCloudT::Ptr target, PointCloudT::Ptr source, Pose startingPose, int iterations){
	...
	// See previous chapter for examples and solutions
...
int main(){
	...
	std::cerr << "PointCloud before filtering: " << scanCloud->width * scanCloud->height 
       << " data points (" << pcl::getFieldsList (*scanCloud) << ")." << std::endl;
